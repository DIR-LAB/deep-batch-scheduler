...
if __name__ == '__main__':
    ...
    parser.add_argument('--workload', type=str, default='./data/SDSC-SP2-1998-4.2-cln.swf', help='Path to workload file to be used for training' )  # RICC-2010-2 lublin_256.swf SDSC-SP2-1998-4.2-cln.swf
    ...
    parser.add_argument('--num_rollouts', type=int, default=100, help='Total number of rollouts to collect during training')
    ...
    if args.trained_model is not None:
        ...
        if args.actor_model in available_models and args.critic_model in available_models:
            ...
            print(f"Invalid model name: {args.actor_model} or {args.critic_model} not in available models: {', '.join(available_models)}")
