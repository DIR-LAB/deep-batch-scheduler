...
class SimpleRandomShuffleHPCEnv(gym.Env):
    def __init__(self):  # do nothing and return. A workaround for passing parameters to the environment
        ...
        print("Initialize Random Shuffle HPC Env V7")
    ...
    def build_observation(self):
        ...
        random.shuffle(self.job_queue)      # shuffle the observation.
    ...
    def step(self, a):
        ...
        if action >= len(self.job_queue):  # this is illegal action; find the most unlikely scheduled legal action and map to it
            jobs = []
