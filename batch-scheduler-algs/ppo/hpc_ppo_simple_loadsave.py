...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='../../data/models/hpc-ppo-simple-162k-Q35-empty-mpi-v2/hpc-ppo-simple-162k-Q35-empty-mpi-v2_s1/')
    ...
    ppo(args.env, workload_file, model_file, ac_kwargs=dict(), gamma=args.gamma,
