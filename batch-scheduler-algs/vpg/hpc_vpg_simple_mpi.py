...
"""
def vpg(env_name, workload_file, model_path, ac_kwargs=dict(), seed=0, 
    ...
    # Setup model saving
    logger.setup_tf_saver(sess, inputs={'x': x_ph}, outputs={'pi': pi, 'v': v, 'logits': logits})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='Scheduler-v6')
    ...
    parser.add_argument('--exp_name', type=str, default='hpc-vpg-simple-25.6k-Q32-mpi-v6')
    ...
    vpg(args.env, workload_file, args.model, ac_kwargs=dict(), gamma=args.gamma, 
